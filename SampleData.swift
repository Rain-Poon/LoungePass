            ...
            Airport(
                ...
                loungeList: [
                    Lounge(
                        ...
                        numRaiting: 4.4,
                        availableFacilities: [
                            Facility(displayName: "Food and beverages bar", description: " Buffet style food and buffet bar for your pre-flight meal ", availableTimeSlots:[]),
                            Facility(displayName: "Work stations", description: "Offers quiet working station high speed Wi-Fi", availableTimeSlots:[])
                        ],
                ...
                loungeList: [
                    Lounge(
                        ...
                        availableFacilities: [
                            Facility(displayName: "Noodle Bar", description: "Serves a freshly made selection of Asian specialties such as Sichuanese dan dan noodles, Singapore Laksa, and Taiwanese beef noodles,", availableTimeSlots:[]),
                            Facility(displayName: "Food and beverages bar", description: " Buffet style food and buffet bar for your pre-flight meal ", availableTimeSlots:[]),
                            Facility(displayName: "Work stations", description: "Including phones, printers, and high-speed Wi-Fi access", availableTimeSlots:[]),
                        ],
